<%@ Page Title="" Language="C#" MasterPageFile="~/forms/instruktor/Instruktor.Master" AutoEventWireup="true" CodeBehind="novaKandidat.aspx.cs" Inherits="Autoskola.Web.forms.instruktor.novaKandidat" %>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="box-body" style="padding-top: 40px">
                            ...
                            <div class="small-box bg-aqua">
                                ...
                                <a class="small-box-footer boxBottom">
                                </a>
                            </div>
                        </div><!-- ./col -->
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-header">
                            ...
                            <asp:Button ID="urediKandidata" runat="server" Text="Uredi" CssClass="btn btn-sm btn-default" style="margin-top: 7px;margin-right: 10px;float: right" OnClick="urediKandidata_Click" />
                        </div>
                        <!-- /.box-header -->
                        <div role="form">
                            <div class="box-body">
                            ...
                            <div class="box-body">
                                <div class="padd">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-5 col-md-9 col-sm-6 col-xs-12 input-group">
                                                <asp:DropDownList ID="list_Instruktori" class="form-control" runat="server"></asp:DropDownList>
                                               </div>
                                        </div>
